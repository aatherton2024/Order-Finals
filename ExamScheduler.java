...
/**
* Class to schedule exams times of students so that no student has multiple
* exams scheduled for the same time slot. Additionally, the number of slots of
* exams offered is as small as possible (given first selected course).
...
public class ExamScheduler {
  ...
  /* Holds slots and exams in each slot */
  ...
  * Creates a vector of vectors vec which stores exams in their slots
  ...
  * @post return vec, a vector of vectors where nested vectors are exams in
  * a specific time slot
  * @post no student has exams at same time, solution cannot be simplified
  * given starting class
  * @return a vector of vectors where nested vectors are exams in a specific
  * time slot
  */
  ...
  * @param slot a vector that stores exams in a specific time slot
  ...
  */
  ...
  /**
  * Method to print out exam slots and the exams scheduled in them
  * @param v the vector containing slots to be printed
  * @post prints out every exam slot and the exams in that slot
  */
  ...
  */
  ...
  /**
  * Main method for ExamScheduler
  * Can take command line argument to find optimal random solution
  * To find random solutions: $ java ExamScheduler #ofTests < filename
  * To find alphabetized catalog: $ java ExamScheduler < filename
  ...
  */
  public static void main(String[] args) {
    ...
    ExamScheduler sched = new ExamScheduler();
